...
class Texture:
    def __init__(self, context):
        ...
        self.textures['skybox'] = self.get_texture('Media/Skybox/minecraft/back.png')
        self.textures['heightmap'] = self.get_texture('Media/textures/hdstone.jpg')
    
    
    def get_texture_skybox(self, texutre_dir='Media/Skybox/minecraft', texture_ext='png'):
        '''
        TODO: Implement this function to load all the textures for the skybox
        '''
        pass
