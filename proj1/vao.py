class VAO:
    ...
    def __init__(self, app):
        ...
        self.vaos['skybox'] = self.get_vao(
            program = self.shader.programs['skybox'],
            vbo_name = 'skybox'
        )
       
        '''
        TODO: You'll first want to implement the heightmap VBO and EBO 
        self.vaos['heightmap'] = self.get_vao(
            program = self.shader.programs['heightmap'],
            vbo_name = 'heightmap'
        )
        '''
